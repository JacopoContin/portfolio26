            ...
            <div className="flex min-h-0 flex-col gap-y-8">
                <div className="flex flex-col gap-y-4 items-center justify-center">
                    ...
                    <div className="flex flex-col gap-y-3 items-center justify-center">
                        ...
                        <p className="w-full text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
                            A few
                            case studies, and a few experiments.
                        </p>
                   
                    </div>
                </div>
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-200 mx-auto auto-rows-fr">
                    {DATA.projects.filter((project) => !project.hidden).map((project, id) => (
                        <BlurFade
                            key={project.title}
