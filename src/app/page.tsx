...
import MusicSection from "@/components/section/music-section";
          ...
          <div className="gap-2 gap-y-6 flex flex-col md:flex-row justify-between">
            ...
            <BlurFade delay={BLUR_FADE_DELAY} className="order-1 md:order-2">
              <div className="relative size-24 md:size-32">
                <AvatarOrb />
                {/* Day and night versions of the same shot, framed to line up; the theme crossfades between them. */}
                <div className="relative size-full overflow-hidden rounded-full bg-muted shadow-lg ring-2 ring-background">
                  <Image
                    src={DATA.avatarUrl}
                    alt={DATA.name}
                    fill
